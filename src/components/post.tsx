    ...
    return (
        ...
        <div className=" w-screen h-full ">
            ...
            <div id="o"className="w-full max-w-xl bg-gray-800 mx-auto mt-32 rounded-xl  flex flex-col" >
                ...
                <a className="content lg:text-md md:text-md sm:text-sm text-white mx-4 my-4">{ cookies.likes }</a>
                
                <div>
                <div className='h-16 mt-8 bg-blue-700 rounded-bl-xl rounded-br-xl items-center py-4'>
                { ! button ?(
                    <button className="w-full h-full mx-auto " onClick={() => {setButton(true); addlike(); addliketocookie(); }}>
                    ...
                    <button className="w-full h-full mx-auto" onClick={() => {setButton(false); remove(); removelikefromcookie(); }}>
