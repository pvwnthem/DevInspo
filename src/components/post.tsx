...
export default function Post(props: any) {
    ...
    const addlike = async (id: string) => {
        const {data} = await axios.get(`https://codeideas.herokuapp.com/api/v1/posts/addlike?id=${id}`)
    }
    return (
        ...
        <div className=" w-screen h-full ">
            ...
            <div id="o"className="w-full max-w-xl bg-gray-800 mx-auto mt-32 rounded-xl  flex flex-col" >
                ...
                { ! button ?(
                    <button className="w-full h-full mx-auto " onClick={() => {setButton(true); addlike(props.id)}}>
